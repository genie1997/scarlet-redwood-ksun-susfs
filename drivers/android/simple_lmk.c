...
/* perm 0: keep compiled default, hide /sys/module/simple_lmk fingerprint */
module_param(slmk_minfree, short, 0);
...
module_param(slmk_timeout, short, 0);
...
module_param(slmk_vmpressure, short, 0);
