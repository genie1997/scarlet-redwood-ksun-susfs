...
// UAPI version reported to the manager via GET_INFO
...
// Old 12-byte layout, kept for managers predating the uapi_version field
...
// Old ioctl number (size field 0) for managers using the 12-byte layout
