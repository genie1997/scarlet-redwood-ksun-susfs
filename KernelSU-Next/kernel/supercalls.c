			  ...
			  void __user **arg)
{
    ...
    if (magic2 == SUSFS_MAGIC && current_uid().val == 0) {
        ...
        // external_dir CMDs dropped: Kraken v2.1.0 core has no
        // susfs_set_i_state_on_external_dir() handler (same drift as
        // reorder_mnt_id / try_umount). Not needed for sus_path/mount/kstat.
